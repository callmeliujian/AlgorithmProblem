...
public class _1282_用户分组 {
    // https://leetcode.cn/problems/group-the-people-given-the-group-size-they-belong-to/solution/by-ac_oier-z1bg/
    class Solution {
        public List<List<Integer>> groupThePeople(int[] groupSizes) {
            ...
            for (int i = 0; i < groupSizes.length; i++) {
                ...
                List<Integer> item = hashMap.getOrDefault(key, new ArrayList<>());
                item.add(i);
